...
from eno import CarParkTool

__CHANNEL_USERNAME__ = "eno"
__GROUP_USERNAME__   = "eno"
...
def banner(console):
    ...
    brand_name = figlet_format('ENO', font='bloody')
    colors = [
    ...
    print(Colorate.Horizontal(Colors.rainbow, '      𝐂𝐎𝐍𝐓𝐀𝐂𝐓 𝐌𝐄 𝐓𝐎 𝐁𝐔𝐘 𝐔𝐍𝐋𝐈𝐌𝐈𝐓𝐄𝐃 𝐁𝐀𝐋𝐀𝐍𝐂𝐄 𝐓𝐆 @ENO ')) 
...
def load_player_data(cpm):
    ...
    if response.get('ok'):
        ...
        if 'floats' in data and 'localID' in data and 'money' in data and 'coin' in data:
            ...
            print(Colorate.Horizontal(Colors.rainbow, '==========[ ENO TOOL ]=========='))
